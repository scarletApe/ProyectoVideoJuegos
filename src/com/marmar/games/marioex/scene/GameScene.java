...
import com.marmar.games.marioex.constants.Action;
import com.marmar.games.marioex.constants.EnemySensors;
import com.marmar.games.marioex.constants.GameConstants;
import com.marmar.games.marioex.dynamics.Bullet;
import com.marmar.games.marioex.dynamics.Enemy;
import com.marmar.games.marioex.dynamics.Player;
...
public class GameScene extends BaseScene {
	...
	private void loadLevel(int j) {
		try {
			...
			// ".tmx");
			this.mTMXTiledMap = tmxLoader.loadFromAsset("worlds/MarioTest.tmx");
