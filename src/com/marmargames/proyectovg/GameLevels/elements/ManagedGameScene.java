...
public abstract class ManagedGameScene extends ManagedScene {
	...
	public ManagedGameScene(float pLoadingScreenMinimumSecondsShown) {
		...
		this.setPosition(0, 0);//ResourceManager.getInstance().cameraHeight/2f);
	...
	public Scene onLoadingScreenLoadAndShown() {
		...
		LoadingText = new Text(0,0,ResourceManager.fontDefault32BoldWhite,"Loading...",ResourceManager.getInstance().engine.getVertexBufferObjectManager());
	...
	public void onLoadScene() {
		...
		Text MainMenuButtonText = new Text(10,10,ResourceManager.fontDefault32Bold,"MENU",ResourceManager.getInstance().engine.getVertexBufferObjectManager());
